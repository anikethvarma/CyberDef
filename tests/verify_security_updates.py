...
def test_slowloris():
    ...
    try:
        ...
        print(f"ERROR in test_slowloris: {e}")
        import traceback
        traceback.print_exc()
...
def test_rapid404():
    ...
    try:
        ...
        try:
            ...
            print(f"ERROR during public IP check_group: {e}")
            import traceback
            traceback.print_exc()
        ...
        try:
            ...
            print(f"ERROR during private IP check_group: {e}")
            import traceback
            traceback.print_exc()
        ...
        try:
            ...
            print(f"ERROR during success constraint check_group: {e}")
            import traceback
            traceback.print_exc()

    except Exception as e:
        print(f"ERROR in test_rapid404: {e}")
        import traceback
        traceback.print_exc()
...
def test_resource_exhaustion():
    ...
    try:
        ...
        print(f"ERROR in test_resource_exhaustion: {e}")
        import traceback
        traceback.print_exc()
    ...
    try:
        ...
        def get_event(referrer):
            try:
                ...
                print(f"ERROR building event for referrer '{referrer}': {e}")
                return None
        ...
        for domain in exclude_list:
            try:
                ...
                print(f"ERROR checking CSRF exclusion for domain '{domain}': {e}")
                import traceback
                traceback.print_exc()
                all_passed = False
        ...
        print(f"ERROR in test_csrf_exclusions: {e}")
        import traceback
        traceback.print_exc()
...
def test_ip_prioritization():
    ...
    try:
        ...
        print(f"ERROR in test_ip_prioritization: {e}")
        import traceback
        traceback.print_exc()
